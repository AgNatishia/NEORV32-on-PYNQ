...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LED_controller/s_axi_aclk] [get_bd_pins button_controller/s_axi_aclk] [get_bd_pins cpu_BRAM_controller/s_axi_aclk] [get_bd_pins cpu_alu/clk_i] [get_bd_pins cpu_control_unit/clk_i] [get_bd_pins cpu_external_bus_control/clk_i] [get_bd_pins cpu_regfile/clk_i] [get_bd_pins interface_bus_keeper/clk_i] [get_bd_pins interface_bus_switch/clk_i] [get_bd_pins interface_bus_to_wishbone/clk_i] [get_bd_pins interface_wishbone_to_axi/m_axi_aclk] [get_bd_pins neo_smartconnect/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins pynq_BRAM_controller/s_axi_aclk] [get_bd_pins pynq_smartconnect/aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins LED_controller/s_axi_aresetn] [get_bd_pins button_controller/s_axi_aresetn] [get_bd_pins cpu_BRAM_controller/s_axi_aresetn] [get_bd_pins pynq_BRAM_controller/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_BRAM_controller/S_AXI/Mem0] -force
